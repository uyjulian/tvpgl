...
SOURCES += $(SOURCES_IA32) $(SOURCES_IA32_C) $(SOURCES_IA32_PFRACTION) $(SOURCES_TEMPLATE) $(SOURCES_IA32_PFRACTION_C)
endif
OBJECTS := $(SOURCES:.c=.o)
...
tests/test.o main.o $(SOURCES_TEMPLATE:.cpp=.o): INCFLAGS += -Ivisual/IA32 -Ivisual/IA32_c -Ivisual/IA32_pfraction -Ivisual/IA32_pfraction_c
