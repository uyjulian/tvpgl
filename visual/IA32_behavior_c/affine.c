...
{
	__m64 v11 = _mm_set1_pi16(opa);
	__m64 v13 = _m_por(_mm_cvtsi32_si64(sx), _m_psllqi(_mm_cvtsi32_si64(sy), 0x20u));
	__m64 v17 = _m_por(_mm_cvtsi32_si64(stepx), _m_psllqi(_mm_cvtsi32_si64(stepy), 0x20u));
	for (tjs_int i = 0; i < len; i += 1)
	{
		__m64 v15 = _m_psradi(v13, 0x10u);
		__m64 v16 = _m_punpcklbw(_mm_cvtsi32_si64(dest[i]), _mm_setzero_si64());
...
TVP_GL_IA32_FUNC_DECL(void, TVPInterpLinTransAdditiveAlphaBlend_c, (tjs_uint32 *dest, tjs_int len, const tjs_uint32 *src, tjs_int sx, tjs_int sy, tjs_int stepx, tjs_int stepy, tjs_int srcpitch))
{
	...
	{
		tjs_uint32 *v12 = (tjs_uint32 *)((char *)&src[i2 >> 16] + srcpitch * (i3 >> 16));
		...
		__m64 v18 = _m_punpcklbw(_mm_cvtsi32_si64(*v12), _mm_setzero_si64());
		__m64 v19 = _m_punpcklbw(_mm_cvtsi32_si64(*(tjs_uint32 *)((char *)v12 + srcpitch)), _mm_setzero_si64());
...
{
	__m64 v10 = _mm_set1_pi16(((tjs_uint32)opa >> 7) + opa);
	for (tjs_int i = 0, i2 = sx, i3 = sy; i < len; i += 1, i2 += stepx, i3 += stepy)
	{
		tjs_uint32 *v16 = (tjs_uint32 *)((char *)&src[i2 >> 16] + srcpitch * (i3 >> 16));
		...
		__m64 v22 = _m_punpcklbw(_mm_cvtsi32_si64(*v16), _mm_setzero_si64());
		__m64 v23 = _m_punpcklbw(_mm_cvtsi32_si64(*(tjs_uint32 *)((char *)v16 + srcpitch)), _mm_setzero_si64());
		...
		__m64 v27 = _m_punpcklbw(_mm_cvtsi32_si64(dest[i]), _mm_setzero_si64());
