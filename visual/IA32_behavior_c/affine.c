...
TVP_GL_IA32_FUNC_DECL(void, TVPInterpLinTransAdditiveAlphaBlend_c, (tjs_uint32 *dest, tjs_int len, const tjs_uint32 *src, tjs_int sx, tjs_int sy, tjs_int stepx, tjs_int stepy, tjs_int srcpitch))
{
	...
	for (tjs_int i = 0; i < len; i += 1)
	{
		v12 = (tjs_uint32 *)((char *)&src[(sx + stepx * i) >> 16] + srcpitch * ((sy + stepy * i) >> 16));
		v14 = _mm_set1_pi16((tjs_uint32)(tjs_uint16)(sx + stepx * i) >> 8);
		v17 = _mm_set1_pi16(((tjs_uint32)(tjs_uint16)(sy + stepy * i) >> 8) + ((tjs_uint32)(tjs_uint16)(sy + stepy * i) >> 15));
...
TVP_GL_IA32_FUNC_DECL(void, TVPInterpLinTransAdditiveAlphaBlend_o_c, (tjs_uint32 *dest, tjs_int len, const tjs_uint32 *src, tjs_int sx, tjs_int sy, tjs_int stepx, tjs_int stepy, tjs_int srcpitch, tjs_int opa))
{
	...
	for (tjs_int i = 0; i < len; i += 1)
	{
		v16 = (tjs_uint32 *)((char *)&src[(sx + stepx * i) >> 16] + srcpitch * ((sy + stepy * i) >> 16));
		v19 = _mm_set1_pi16((tjs_uint32)(tjs_uint16)(sx + stepx * i) >> 8);
		v21 = _mm_set1_pi16(((tjs_uint32)(tjs_uint16)(sy + stepy * i) >> 8) + ((tjs_uint32)(tjs_uint16)(sy + stepy * i) >> 15));
