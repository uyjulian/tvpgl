...
void __cdecl TVPAlphaBlend_o_mmx_pfraction_c(tjs_uint32 *dest, const tjs_uint32 *src, tjs_int len, tjs_int opa)
{
	...
	if (len > 0)
	{
		...
		if (dest < v6)
		{
			do
			{
				v7  = _mm_cvtsi32_si64((unsigned int)opa * (tjs_uint64)*v5 >> 32);
				v8  = _m_punpcklwd(v7, v7);
...
void __cdecl TVPAlphaBlend_HDA_mmx_pfraction_c(tjs_uint32 *dest, const tjs_uint32 *src, tjs_int len)
{
	...
	if (len - 1 >= 0)
	{
		...
		{
			v4       = src[v3];
			v5       = _mm_cvtsi32_si64(v4 >> 24);
			v6       = _mm_cvtsi32_si64(v4);
			v7       = _m_punpcklwd(v5, v5);
			v8       = dest[v3];
	...
	if (len > 0)
	{
		...
		if (dest < v6)
		{
			do
			{
				...
				v9  = _mm_cvtsi32_si64(TVPOpacityOnOpacityTable[v7]);
