...
#endif
#if 0
		tjs_uint32 sopa = _mm_cvtsi128_si32(_mm_shuffle_epi32(ma1, 0xFF));
		tjs_uint32 d = _mm_cvtsi128_si32(_mm_shuffle_epi32(md1, 0xFF));
		tjs_uint32 s = _mm_cvtsi128_si32(_mm_shuffle_epi32(ms1, 0xFF));
